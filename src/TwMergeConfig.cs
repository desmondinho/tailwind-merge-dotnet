    ...
    public TwMergeConfig()
    {
        ...
        ClassGroups = new( 270 )
        {
            ...
            */
             ...
             */
            ["start"] = new( [
                new ClassGroup( "inset-s", insetScale ),
                // Deprecated since Tailwind CSS v4.2.0 in favor of `inset-s-*` utilities. See https://github.com/tailwindlabs/tailwindcss/pull/19613
             ...
             */
            ["end"] = new( [
                new ClassGroup( "inset-e", insetScale ),
                // Deprecated since Tailwind CSS v4.2.0 in favor of `inset-e-*` utilities. See https://github.com/tailwindlabs/tailwindcss/pull/19613
                new ClassGroup( "end", insetScale )
            ] ),
            /*
             * Inset Block Start
             * See https://tailwindcss.com/docs/top-right-bottom-left
             */
            ["inset-bs"] = new( "inset-bs", insetScale ),
            /*
             * Inset Block End
             * See https://tailwindcss.com/docs/top-right-bottom-left
             */
            ["inset-be"] = new( "inset-be", insetScale ),
            /*
             * Top
             * See https://tailwindcss.com/docs/top-right-bottom-left
             */
